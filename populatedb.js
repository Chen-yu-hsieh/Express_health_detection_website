...
var mongoDB = "mongodb+srv://<user_name>:<password>@cluster0.kvowd.mongodb.net/?retryWrites=true&w=majority";
...
function dataCreate(data, date, time, cb) {
  datadetail = {user: "62934d83e6b7363410fdf54f" ,sensor:"62966282473f9a48d0eb6cd9" ,data: data, date: date, time: time};
...
function createData(cb){
  async.series([
    function(callback){
    dataCreate(74, '2022-06-03','15:31:20', callback);
    },
    function(callback){
      dataCreate(61, '2022-06-03','15:32:20', callback);
    },
    function(callback){
      dataCreate(50, '2022-06-03','15:33:20', callback);
    },
    function(callback){
      dataCreate(75.3, '2022-06-03','15:34:20', callback);
    },
    function(callback){
      dataCreate(77.9, '2022-06-04','08:03:20', callback);
    },
    function(callback){
      dataCreate(71.3, '2022-06-04','08:05:20', callback);
    },
    function(callback){
      dataCreate(65, '2022-06-04','08:06:20', callback);
    },
    function(callback){
      dataCreate(71, '2022-06-04','08:06:30', callback);
    },
    function(callback){
      dataCreate(75.9, '2022-06-04','08:08:20', callback);
    },
    function(callback){
      dataCreate(60.9, '2022-06-04','08:10:20', callback);
    }
  ],
  cb);
}
